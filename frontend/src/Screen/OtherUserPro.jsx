...
const OtherUserPro = () => {
  ...
  const handleFollowClick = () => {
    if (isFollowing) {
      // Unfollow logic
      axios
        .post(`${BASE_URL}/api/users/unfollow/${userId}`, null, {
      ...
      // Follow logic
      axios
        .post(`${BASE_URL}/api/users/follow/${userId}`, null, {
          withCredentials: true,
        })
        .then(() => {
          setIsFollowing(true);
  ...
  useEffect(() => {
    ...
    axios.get(`${BASE_URL}/api/users/checkFollowing/${userId}`, {
      withCredentials: true,
    })
    .then(response => {
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/api/users/authorProfile/${userId}`)
...
// Fetch user's blogs
axios
.get(`${BASE_URL}/api/blogs/getUserBlogs/${userId}`,{
withCredentials:true
})
.then(response => {
...
.catch(error => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${BASE_URL}/api/users/followerFollowingCount/${userId}`, {
        withCredentials: true,
      })
      .then(response => {
  ...
  const handleChatButtonClick = async () => {
    try {
      const response = await axios.get(
        `${BASE_URL}/api/chats/createOrGetChatRoom/${userId}`,
        { withCredentials: true }
      );
