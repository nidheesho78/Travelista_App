...
useEffect(() => {
  ...
  const fetchTotalUsersCount = async () => {
    try {
      const response = await axios.get(`${BASE_URL}/api/admin/countOfTotalUsers`,{
  ...
  const fetchTotalBlogsCount = async () => {
    try {
      const response = await axios.get(`${BASE_URL}/api/admin/countOfTotalBlogs`,{
        withCredentials: true
      });
  ...
  const fetchTopUsersWithMostFollowers = async () => {
    try {
      const response = await axios.get(`${BASE_URL}/api/admin/topUsersWithMostFollowers`,{
        withCredentials: true
      });
  ...
  const fetchTopLikedBlogs = async () => {
    try {
      const response = await axios.get(`${BASE_URL}/api/admin/topLikedBlogs`,{
        withCredentials: true
      });
