...
const ViewBlog = () => {
  ...
  const handleBookmarkClick = async () => {
    try {
      await axios.post(`${BASE_URL}/api/blogs/saveBlog/${selectedBlog._id}`, null, {
  ...
  useEffect(() => {
    axios.get(`${BASE_URL}/api/blogs/countLike/${blogId}`)
      .then(response => {
    ...
    axios.get(`${BASE_URL}/api/blogs/checkLike/${blogId}`, {
      withCredentials: true,
    })
      .then(response => {
  ...
  useEffect(() => {
    ...
    fetch(`${BASE_URL}/api/blogs/getOneBlog/${blogId}`) // Adjust the API route accordingly
  ...
  const handleLikeClick = async () => {
    try {
      await axios.post(`${BASE_URL}/api/blogs/likeBlog/${selectedBlog._id}`, null, {
        withCredentials: true,
      });
