...
import { faPen, faSave, faComment } from '@fortawesome/free-solid-svg-icons';
...
//user following count
  useEffect(() => {
    ...
    axios
      .get(`${BASE_URL}/api/users/followerFollowingCount/${userInfo._id}`, {
  ...
  const handleDeleteBlog = async (blogId) => {
    try {
      ...
      if (result.isConfirmed) {
        await axios.delete(`${BASE_URL}/api/blogs/deleteBlog/${blogId}`, {
          withCredentials: true,
        });
...
? `${BASE_URL}/api/users/uploads/${userInfo.profileImage}`
  ...
  return (
    <div className="profile-container" >
     ...
     <div className="profile-picture">
      ...
      <div className='showcase' style={{justifyContent:'space-around'}}>
